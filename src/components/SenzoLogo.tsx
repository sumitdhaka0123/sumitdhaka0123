  ...
  if (layout === 'compact') {
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        ...
        <div className="flex items-baseline font-sans font-black tracking-tight text-lg select-none">
          <span className="text-red-600">Sen</span>
          <span className={isDark ? 'text-white' : 'text-slate-900'}>zo</span>
        </div>
      </div>
    );
  }
  ...
  if (layout === 'banner') {
    return (
      <div className={`flex flex-col items-center justify-center text-center p-4 ${className}`}>
        ...
        <span className={`text-[10px] font-bold tracking-widest uppercase font-sans ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
          Senzo Electric India Pvt. Ltd.
        </span>
      </div>
    );
  }

  // Default 'full' layout (stacked logo with underline and pvt ltd details)
  return (
    <div className={`flex flex-col items-center p-2 ${className}`}>
      ...
      {/* Senzo brand name */}
      <div className="flex items-baseline font-sans font-extrabold tracking-tight text-4xl mt-1 select-none">
        <span className="text-red-600">Sen</span>
        <span className={isDark ? 'text-white' : 'text-slate-900'}>zo</span>
      </div>
      ...
      <div className={`text-[10px] sm:text-[11px] font-black tracking-wide uppercase font-sans ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
        Senzo Electric India Pvt. Ltd.
      </div>
    </div>
  );
