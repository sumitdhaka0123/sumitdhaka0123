...
export default function SettingsPanel({
  ...
  return (
    <div className="space-y-6" id="settings-component">
      ...
      <div className="flex bg-slate-100 p-1.5 rounded-2xl border border-slate-200 max-w-2xl no-print animate-fade-in" id="settings-subtabs">
        <button
          type="button"
